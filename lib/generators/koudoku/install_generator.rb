...
module Koudoku
  class InstallGenerator < Rails::Generators::Base
    ...
    def install
      ...
      generate("model", "subscription stripe_id:string plan_id:integer last_four:string coupon_id:integer card_type:string current_price_cents:integer #{subscription_owner_model}_id:integer")
      template "app/models/subscription.rb"

      # Add the plans.
      generate("model", "plan name:string stripe_id:string price_cents:integer interval:string features:text highlight:boolean display_order:integer")
